    ...
    return(
        ...
        <div className=" bg-transparent md:bg-[#3a464c] rounded-2xl max-w-4xl mx-auto my-10  py-4  px-6 ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 ">
                <div className="w-full px-3">
                    <Form method="post" className="flex flex-col gap-5 w-full max-w-md mx-auto">
                        ...
                        <div>
                            <Field label="Adj meg egy erős jelszót: " placeholder="a te jelszavad" type="text" name="password"/>
                             <p className="text-red-600 text-2xl pt-3 font-semibold"></p>
                        </div>
                        <div>
                            <Field label="Erősítsd meg a jelszavad: " placeholder="a te jelszavad újra" type="text" name="confirmPassword"/>
                             <p className="text-red-600 text-2xl pt-3 font-semibold"></p>
                        </div>
                    </Form>
            ...
            <div className=" flex flex-col md:flex-row items-center md:justify-between w-full py-2 px-3 gap-6 md:gap-30">
                <button type="submit" className="bg-[#cc2936] text-white text-lg border-2 border-transparent hover:border-[#eee5e9] sm:w-fit mx-auto md:ml-24 mt-6 px-8 py-4 rounded-xl">Regisztrálok!</button>
