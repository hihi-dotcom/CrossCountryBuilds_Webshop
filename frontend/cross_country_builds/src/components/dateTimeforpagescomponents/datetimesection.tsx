    ...
    return(
        <>
            ...
            <div className="hidden container max-w-5xl sm:flex flex-wrap mx-auto items-center text-amber-50 bg-[#9c1f2a] w-full px-7 rounded-3xl my-20 py-5 ">
                ...
                <button type="button" className=" flex flex-col  bg-[#404d53] text-white p-3.5 rounded-lg whitespace-nowrap ml-auto hover:font-bold border-2 border-transparent hover:border-white" onClick={handleNavigateButtonClick}>Foglalok!</button>
            </div>
