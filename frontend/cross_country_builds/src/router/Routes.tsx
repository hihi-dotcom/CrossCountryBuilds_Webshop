...
import OrderEndGuard from "../pages/protects/OrderEndGuard";
        ...
        children: [
...

          {
            ...
            children: [
              ...
              {
                element: <OrderEndGuard />,
                children: [{ path: "orderend", element: <EndofOrderPage /> }],
              },
              {
                path: "appointment",
